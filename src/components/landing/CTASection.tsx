...
const CTASection = () => {
  ...
  return (
    <section className={cn(
      ...
      {/* Active Radial Auras */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[1200px] h-[1200px] rounded-full blur-[180px] bg-primary/10 animate-pulse-slow pointer-events-none" />
      ...
      <div className="container mx-auto max-w-7xl relative z-10 text-center">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-10 items-center w-full sm:w-auto">
            <Link to="/auth" className="w-full sm:w-auto">
              <button className="w-full h-20 px-16 bg-primary text-black font-black uppercase text-[12px] tracking-[0.4em] rounded-full hover:scale-105 hover:shadow-[0_0_50px_rgba(34,211,238,0.4)] active:scale-95 transition-all shadow-2xl">
                START FREE NOW
              </button>
            </Link>
            <button className={cn(
        ...
        >
          ...
          {/* Bottom Active Glow */}
          <div className="absolute -bottom-40 left-1/2 -translate-x-1/2 w-[90%] h-96 bg-primary/20 blur-[200px] -z-10 rounded-full animate-pulse-slow" />
        </motion.div>
      </div>
    </section>
  );
